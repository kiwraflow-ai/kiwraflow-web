  ...
  const plans = [
    {
      ...
      features: ["Até 5 contratos", "Relatórios básicos", "Suporte por email"],
      popular: false,
    },
    {
      id: "PROFESSIONAL",
      ...
      features: ["Contratos ilimitados", "Relatórios avançados", "Suporte prioritário", "Integração com WhatsApp"],
      popular: true,
    },
    {
      id: "ENTERPRISE",
      ...
      features: ["Tudo do Professional", "API personalizada", "Suporte dedicado", "Treinamento personalizado"],
      popular: false,
    },
  ];
