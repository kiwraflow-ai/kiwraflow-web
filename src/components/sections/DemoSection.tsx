              ...
              <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-100">
                ...
                {isPlaying && (
                  <motion.div
                    ...
                    className="mt-6 p-4 bg-kiwi/10 rounded-lg border border-kiwi/20"
                  >
          ...
          >
            {features.map((feature, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
                whileHover={{ x: 10 }}
                className="flex items-start space-x-4 p-6 rounded-xl hover:bg-gray-50 transition-colors border border-gray-100"
              >
